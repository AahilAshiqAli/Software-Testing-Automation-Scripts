...
if __name__ == '__main__':
    try:
        ...
        driver.find_element(By.ID, "email").send_keys("aahilashiqali@gmail.com")
        ...
        assert success_text == "Thank you for your review.", f"Expected success message not shown, found: {success_text}"

        print("✅ Assertion Passed: Review submission success message is shown correctly.")
